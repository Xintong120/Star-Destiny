  ...
  static calculateHoroscope(
    ...
    const scope: Horoscope = {
      ...
      decadal: {
        ...
        palaceNames: PalaceNameService.getHoroscopePalaceNames(decadalIndex, true, 'decadal'),
      ...
      age: {
        ...
        palaceNames: PalaceNameService.getHoroscopePalaceNames(ageIndex, false, 'age'),
      ...
      yearly: {
        ...
        palaceNames: PalaceNameService.getHoroscopePalaceNames(yearlyIndex, false, 'yearly'),
      ...
      monthly: {
        ...
        palaceNames: PalaceNameService.getHoroscopePalaceNames(monthlyIndex, false, 'monthly'),
      ...
      daily: {
        ...
        palaceNames: PalaceNameService.getHoroscopePalaceNames(dailyIndex, false, 'daily'),
      ...
      hourly: {
        ...
        palaceNames: PalaceNameService.getHoroscopePalaceNames(hourlyIndex, false, 'hourly'),
